...
type Renderer interface {
	ResultOutput() string        // text or SVG output
	PrintHTML(buf *bytes.Buffer) // evy source, text or SVG output
}
...
// ResultOutput returns the SVG content as a string.
func (s SVGContent) ResultOutput() string {
	return string(s)
}

// PrintHTML prints the SVG content as is.
func (s SVGContent) PrintHTML(buf *bytes.Buffer) {
...
// ResultOutput executes the Evy source code and returns the text or image output as
// a string.
func (s *evySource) ResultOutput() string {
	if s.output == "" {
...
// PrintHTML prints evy source code.
func (s *evySource) PrintHTML(buf *bytes.Buffer) {
...
// ResultOutput returns the plain text output of an Evy program content as a
// string.
func (s TextContent) ResultOutput() string {
	return string(s)
}

// PrintHTML prints text output inside a <pre><code> element.
func (s TextContent) PrintHTML(buf *bytes.Buffer) {
