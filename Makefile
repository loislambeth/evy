...
.PHONY: build-full build-go build-tiny embed embed go-version install install-full tidy
...
GODOCFILES = main.go learn/cmd/learnevy/main.go
godoc: install
