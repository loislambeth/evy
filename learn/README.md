...
`learnevy` is a tool for creating and previewing Evy practice and learn materials.
...
Try it with
    ...
    make install
    learnevy export pkg/question/testdata/course1/unit1/exercise1/questions/question1.md
    learnevy seal pkg/question/testdata/course1/unit1/exercise1/questions/question1.md

For sample error messages in case of failed verification, try

    learnevy verify pkg/question/testdata/course1/unit1/err-exercise1/questions/err-false-negative.md
...
production!
    ...
    learnevy unseal pkg/question/testdata/course1/unit1/exercise1/questions/question1-sealed.md
